			...
			<div class="container">
				<div class="top-area-items clearfix">
					...
					<?php if(scalia_get_option('top_area_style') == 1) : ?>
						...
						<?php endif; ?>
							<!-- Theme Customization: adding navigation to the header -->
						<?php if(has_nav_menu('header-menu')) : ?>
						<nav id="secondary-navigation" class="site-navigation primary-navigation" role="navigation">
							<?php wp_nav_menu( array( 'theme_location' => 'header-menu', 'menu_id' => 'secondary-menu', 'menu_class' => 'nav-menu dl-menu styled no-responsive', 'container' => false, 'walker' => new Scalia_Mega_Menu_Walker)); ?>
						</nav>
					<?php endif; ?>
					<?php else : ?>
						<?php if(scalia_get_option('top_area_contacts')) : ?>
		...
		<div class="container">
			<div class="header-main logo-position-<?php echo esc_attr(scalia_get_option('logo_position', 'left')); ?>">
				...
				<nav id="primary-navigation" class="site-navigation primary-navigation" role="navigation">
					<button class="menu-toggle dl-trigger"><?php _e('Primary Menu', 'codeus'); ?></button>
