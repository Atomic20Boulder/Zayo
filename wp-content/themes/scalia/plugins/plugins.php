...
function scalia_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'slug' => 'wp-page-widget',
			'source' => 'https://downloads.wordpress.org/plugin/wp-page-widget.zip',
			'required' => true,
			'version' => '',
			'force_activation' => true,
			'force_deactivation' => false,
		...
		array(
			...
			'source' => 'https://downloads.wordpress.org/plugin/jw-player-plugin-for-wordpress.zip',
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
...
function scalia_updater_plugin_load() {
	...
	$args = array(
		...
		'remote_url'  => 'http://codex-themes.com/scalia/required-plugins/scalia-import.json',
		'version'     => $plugin_data['Version'],
		'key'         => ''
	);
	$tgm_updater = new TGM_Updater( $args );
