...
<?php
	$comments_form_args = array(
		...
		'logged_in_as' => '<p>'.sprintf(__('Logged in as <a href="%1$s">%2$s</a>.'), get_edit_user_link(), $user_identity).' <a href="'.wp_logout_url(get_permalink()).'" title="'.esc_attr__('Log out of this account', 'scalia').'">'.__('Log out &raquo;', 'scalia').'</a></p>',
