...
function scalia_cart_short_info() {
	global $woocommerce;
	echo '<div class="cart-short-info">'.sprintf(__('You Have <span class="items-count">%d Items</span> In Your Cart', 'codeus'), $woocommerce->cart->cart_contents_count).'</div>';
}
...
function scalia_product_tabs($tabs = array()) {
		...
		if (!isset($tabs['description']) && get_post_meta($post->ID, 'scalia_product_description', true)) {
