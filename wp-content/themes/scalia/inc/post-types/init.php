...
<table class="settings-box-table" width="100%"><tbody><tr>
	...
	<td>
		...
		<?php _e('Enter icon code', 'scalia'); ?>. <a href="<?php echo scalia_user_icons_info_link(); ?>" onclick="tb_show('<?php _e('Icons info', 'codeus'); ?>', this.href+'?TB_iframe=true'); return false;"><?php _e('Show Icon Codes', 'codeus'); ?></a><br />
		<br />
...
function scalia_get_sanitize_page_title_data($post_id = 0, $item_data = array()) {
	...
	$page_data['title_excerpt'] = sanitize_text_field($page_data['title_excerpt']);
