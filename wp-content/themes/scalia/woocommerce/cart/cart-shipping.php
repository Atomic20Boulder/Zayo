	...
	<td>
		<?php if ( ! empty( $available_methods ) ) : ?>
			...
			<?php elseif ( get_option( 'woocommerce_shipping_method_format' ) === 'select' ) : ?>
				...
				<select name="shipping_method[<?php echo esc_attr($index); ?>]" data-index="<?php echo esc_attr($index); ?>" id="shipping_method_<?php echo esc_attr($index); ?>" class="shipping_method sc-combobox">
				...
				<ul id="shipping_method" class="styled">
					<?php foreach ( $available_methods as $method ) : ?>
						<li>
							...
							<input type="radio" name="shipping_method[<?php echo esc_attr($index); ?>]" data-index="<?php echo esc_attr($index); ?>" id="shipping_method_<?php echo esc_attr($index); ?>_<?php echo sanitize_title( $method->id ); ?>" value="<?php echo esc_attr( $method->id ); ?>" <?php checked( $method->id, $chosen_method ); ?> class="shipping_method sc-checkbox" />
						</li>
					<?php endforeach; ?>
				</ul>
