...
function scalia_youtube_shortcode($atts) {
	...
	$return_html = '<div class="sc-youtube sc-wrapbox sc-wrapbox-style-'.$classes.($position ? ' sc-wrapbox-position-'.$position : '').'" style="'.$css_style.'">'.
		'<div class="sc-wrapbox-inner">'.
		($style == '12' ? '<div class="shadow-wrap">' : '').
		'<iframe class="sc-wrapbox-element img-responsive" width="'.$width.'" height="'.intval($height).'" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://www.youtube.com/embed/'.$video_id.'?rel=0&amp;wmode=opaque"></iframe>'.
		($style == '12' ? '</div>' : '').
		'</div>'.
		'</div>';
	return $return_html;
...
function scalia_vimeo_shortcode($atts) {
	...
	$return_html = '<div class="sc-vimeo sc-wrapbox sc-wrapbox-style-'.$classes.($position ? ' sc-wrapbox-position-'.$position : '').'" style="'.$css_style.'">'.
		'<div class="sc-wrapbox-inner">'.
		($style == '12' ? '<div class="shadow-wrap">' : '').
		'<iframe class="sc-wrapbox-element img-responsive" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://player.vimeo.com/video/'.$video_id.'?title=0&amp;byline=0&amp;portrait=0"></iframe>'.
		($style == '12' ? '</div>' : '').
		'</div>'.
		'</div>';
	return $return_html;
...
function scalia_video_shortcode($atts) {
	...
	$return_html = '<div class="sc-video sc-wrapbox sc-wrapbox-style-'.$classes.($position ? ' sc-wrapbox-position-'.$position : '').'" style="'.$css_style.'">'.
		'<div class="sc-wrapbox-inner">'.
		($style == '12' ? '<div class="shadow-wrap">' : '').
		scalia_selfvideo($video_src, $image_src, '100%', '100%', 'sc-wrapbox-element img-responsive').
		($style == '12' ? '</div>' : '').
		'</div>'.
		'</div>';
	return $return_html;
